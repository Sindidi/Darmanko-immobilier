 ...
 */
class Client extends \SNT\DarmankoBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Client' . "\0" . 'numpiece', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Client' . "\0" . 'nomComplet', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Client' . "\0" . 'tel', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Client' . "\0" . 'adress', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Client' . "\0" . 'email', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Client' . "\0" . 'motdepasse'];
        }
