 ...
 */
class TypeBien extends \SNT\DarmankoBundle\Entity\TypeBien implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\TypeBien' . "\0" . 'id', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\TypeBien' . "\0" . 'libelle', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\TypeBien' . "\0" . 'niveau'];
        }
